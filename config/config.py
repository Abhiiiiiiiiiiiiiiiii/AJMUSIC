...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Abhiiiiiiiiiiiiiiiii/AJMUSIC",
)
...
START_IMG_URL = getenv("START_IMG_URL", "https://te.legra.ph/file/6a4388033fff607c2327f.jpg")

PING_IMG_URL = getenv(
    "PING_IMG_URL",
    "https://telegra.ph//file/4243d7141a1acef2c2f6d.jpg",
)
